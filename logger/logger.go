...
const (
	BindError                   = "Cannot bind the JSON. The client may sent unexpected data."
	InstanceCreationErrorSQL    = "Instance creation error. Source: Database"
	RecordCouldNotFound         = "Record could not found in the database."
	ObjectCreated               = "Object created successfuly."
	UnauthorizedAccessOperation = "You are not authorized to access this object!"
